        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed">
              Experience the magic of the Aegean at our luxurious coastal retreat.
              Where sun-kissed days and unforgettable memories await.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "Rooms", "Amenities", "Activities", "Gallery", "Contact"].map(
                (item) => (
                  <li key={item}>
                    <Link
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:greeceinblue@gmail.com"
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-primary-foreground/80">
                  Anakkatti, Coimbatore, Tamil Nadu, India
                </span>
              </li>
            </ul>
          </div>
